...
private:
    static unsigned int prog_yuv;
    static unsigned int texUniformY;
    static unsigned int texUniformU;
    static unsigned int texUniformV;
    unsigned int tex_yuv[3];
    ...
    // // shader中yuv变量地址
    // unsigned int unis[3] = {0};
    // // openg的 texture地址
    // unsigned int texs[3] = {0};
    // //材质内存空间
