...
int Direct3D9Render::InitD3D(HWND hwnd, int lWidth, int lHeight)
{
    HRESULT lRet;
...
int Direct3D9Render::drawVideo(const void *data, int pixel_w, int pixel_h)
{
    HRESULT lRet;
